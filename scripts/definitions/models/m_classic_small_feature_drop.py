...
class MClassicSmallFeatureDrop(torch.nn.Module):
    @staticmethod
    def create(input_size):
        return MClassicSmallFeatureDrop(input_size)

    def __init__(self, input_size):
        super(MClassicSmallFeatureDrop, self).__init__()
        ...
        self.class_drop3 = torch.nn.Dropout(p=0.5)
    ...
    def forward(self, X):
        ...
        X = self.class_drop3(self.class_activation3(self.class_linear3(X)))
