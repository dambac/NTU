...
def ci_try_split_subjects_into_sets():
    """
    Split samples into sets using algorithm similar to the one for partition problem.
    """
    distributions_in_subjects = unpickle_obj(f"{C.DistributionsAndSets.DISTRIBUTIONS_RESULTS}/dist_chart_images_10/subjects.pickle")
