...
def save_which_video_and_subject_is_in_which_set():
    ...
    """
    split_of_videos_into_sets = web_try_split_videos_into_sets()
    split_of_videos = {
    ...
    save_json(split_of_videos, f"{C.DistributionsAndSets.SETS_SPLITS}/websites_videos_for_sets.json")

    split_of_subjects_into_sets = web_try_split_subjects_into_sets()
    split_of_subjects = {
    ...
    save_json(split_of_subjects, f"{C.DistributionsAndSets.SETS_SPLITS}/websites_subjects_for_sets.json")
...
if __name__ == "__main__":
    ...
    set_to_videos = read_json(f"{C.DistributionsAndSets.SETS_SPLITS}/websites_videos_for_sets.json")
    set_to_subjects = read_json(f"{C.DistributionsAndSets.SETS_SPLITS}/websites_subjects_for_sets.json")

    split_samples_to_sets_by_their_video(samples_name="websites_10s_pure",
                                         set_to_videos=set_to_videos,
                                         result_name="websites_10s_pure_by_video")
    split_samples_to_sets_by_their_subject(samples_name="websites_10s_pure",
                                           set_to_subjects=set_to_subjects,
                                           result_name="websites_10s_pure_by_subject")
