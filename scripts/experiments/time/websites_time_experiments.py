...
def run_time_experiment(name, model, t_model, optimizer):
    run_params = RunParams.from_json_dict({
        "name": name,
        "output_dir": "websites/time_experiments",
        "dataset_params": {
            "samples_file_name": "websites_10s_pure",
            "samples_split": "websites_10s_pure_by_subject",
            "labels_weights": [1, 1],
        },
        "train_params": {
            "batch_size": 128,
...
def websites_vgg_time_experiments():
    models = ["m_classic",
              "m_classic_drop1",
              "m_classic_drop_old",
...
def websites_transfer_models_time_experiments():
    models = ["m_classic"]
...
if __name__ == "__main__":
    websites_vgg_time_experiments()
    websites_transfer_models_time_experiments()
