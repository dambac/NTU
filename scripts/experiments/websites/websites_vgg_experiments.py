...
def run_experiments_with_split_per_subject(name, model, t_model, optimizer):
    run_params = RunParams.from_json_dict({
        "name": name,
        "output_dir": "websites/model_experiments_subject",
        "dataset_params": {
...
def run_experiments_with_split_per_video(name, model, t_model, optimizer):
    run_params = RunParams.from_json_dict({
        "name": name,
        "output_dir": "websites/model_experiments_video",
        "dataset_params": {
            "samples_file_name": "websites_10s_pure",
...
if __name__ == "__main__":
    """
    Run all VGG experiments for websites
    """
    websites_vgg_experiments()
